...
// <vc-helpers>
/* helper modified by LLM (iteration 3): removed duplicate Pow function definition */
...
// <vc-code>
{
  /* code modified by LLM (iteration 3): simplified implementation without unverifiable postconditions */
  if |roots| == 0 {
    coeffs := [1.0];
  } else {
