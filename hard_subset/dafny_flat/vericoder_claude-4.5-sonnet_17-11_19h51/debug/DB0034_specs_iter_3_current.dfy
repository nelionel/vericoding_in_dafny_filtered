  ...
  decreases e
{
  if e == 0 {
    ...
    ExpAddExponent(base, e, e);
    ExpDoubleExponent(base, e - 1);
  }
}
...
// <vc-code>
{
  /* code modified by LLM (iteration 3): Simplified approach using direct axiom-free implementation */
  var n := Str2Int(sz);
  ...
  if last == '0' {
    ...
    ExpDoubleExponent(Str2Int(sx), y_half);
    ModProperty(Exp_int(Exp_int(Str2Int(sx), 2), y_half), Str2Int(sx), n);
    res := temp;
  }
}
// </vc-code>
