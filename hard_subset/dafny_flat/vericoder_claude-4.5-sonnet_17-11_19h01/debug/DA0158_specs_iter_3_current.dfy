...
// <vc-helpers>
/* helper modified by LLM (iteration 3): fixed concat_seqs_append proof with explicit sequence slicing */
...
// <vc-code>
{
  /* code modified by LLM (iteration 3): added lemma calls and fixed invariant maintenance */
  if k <= 0 || |q| == 0 {
    result := [];
    return;
  }
