...
// <vc-helpers>
/* helper modified by LLM (iteration 2): added decreases clause and bounds checking */
...
// </vc-spec>
// <vc-code>
/* code modified by LLM (iteration 2): added lemma calls to prove helper preconditions and improved proof */
{
