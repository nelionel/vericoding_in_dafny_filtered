...
// <vc-helpers>
/* helper modified by LLM (iteration 2): added lemma to prove count property is maintained when extending sequence */
...
// </vc-spec>
// <vc-code>
/* code modified by LLM (iteration 2): added lemma calls to prove loop invariant and postconditions */
{
  var neg_count := 0;
  var i := 0;
  while i < n
