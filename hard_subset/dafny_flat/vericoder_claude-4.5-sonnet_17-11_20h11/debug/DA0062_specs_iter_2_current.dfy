...
// <vc-helpers>
/* helper modified by LLM (iteration 2): added lemma to prove vasya_eats is monotonic in k */
...
// </vc-spec>
// <vc-code>
/* code modified by LLM (iteration 2): start from n and search downward to find minimal k */
{
  result := n;
  while result > 1
