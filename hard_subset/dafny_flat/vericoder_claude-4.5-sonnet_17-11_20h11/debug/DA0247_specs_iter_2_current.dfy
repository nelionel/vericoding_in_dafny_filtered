...
// <vc-helpers>
/* helper modified by LLM (iteration 2): Added ensures clause to guarantee result > 0 when waves non-empty */
function CalculateMinimumBulletsHelper(waves: seq<Wave>, k: nat, waveIndex: nat, bulletsInChamber: nat): nat
    ...
    ensures waveIndex < |waves| ==> result > 0
...
// </vc-spec>
// <vc-code>
/* code modified by LLM (iteration 2): Added assertions to prove CanSolveAllWaves after validation loop */
{
    if |waves| == 0 {
        return 0;
    }
